...
(function (h5game) {
    ...
    (function (Utils) {
        ...
        * @return 弧度值。
        */
        function getRotation(x0, y0, x1, y1) {
            return Math.atan2(y1 - y0, x1 - x0) / Math.PI * 180;
        }
        Utils.getRotation = getRotation;
        /**
         * 两点间距离
         * @param {*} x0
         * @param {*} y0
        ...
        Utils.calcDist = calcDist;
        /**
         * 数字转换大写
         * @param {*} value
         */
        function number2Chinese(value) {
            var valueStr = value + '';
        ...
        Utils.number2Chinese = number2Chinese;
        /**
         * 获取本周星期几日期
         * @param {*} num
         */
        function getWeekByNum(num) {
            var date = new Date();
            date.setHours(0, 0, 0, 0);
            date.setDate(date.getDate() + (num - date.getDay()));
            return date;
        }
        Utils.getWeekByNum = getWeekByNum;
        var m_vRollNumberTimerList = [];
        /**
         * 开始滚动数字效果
         *
         * @param p_type
         ...
         * @param p_labelNode
         */
        function startRollNumberEffect(p_type, p_nNumber, p_nOldNumber, p_labelNode) {
        ...
        Utils.startRollNumberEffect = startRollNumberEffect;
    })(Utils = h5game.Utils || (h5game.Utils = {}));
})(h5game || (h5game = {}));
