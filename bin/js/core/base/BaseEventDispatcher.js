...
(function (h5game) {
    ...
    var BaseEventDispatcher = /** @class */ (function (_super) {
        ...
        // }
        BaseEventDispatcher.prototype.ifStageEvent = function (id) {
            return false;
        };
        /**
         * 添加事件
         ...
         * @param handler
         */
        BaseEventDispatcher.prototype.addEventListener = function (id, target, handler) {
         ...
         * @param target
         */
        BaseEventDispatcher.prototype.removeEventListener = function (id, target) {
            if (this._dictEvtForm[id] != undefined) {
         ...
         * @param all
         */
        BaseEventDispatcher.prototype.dispatch = function (id, target, evt, all) {
    ...
    h5game.BaseEventDispatcher = BaseEventDispatcher;
})(h5game || (h5game = {}));
