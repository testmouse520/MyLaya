...
module h5game {
    ...
    export class EffectUtils extends BaseClass {
         ...
         */
        macIconShake(obj: Laya.Sprite, initY: number, callback: Function, thisObj: any): void {
            //抖动频率[时间，移动距离]，可修改
            let arr = [
                [20, 300],
                [15, 300],
         ...
         */
        flowOut(obj: Laya.Sprite, time: number = 500, ease: Function = null, callback: Function = null, thisObj: any = null, arrData: Array<any> = null): void {
            if (callback) {
